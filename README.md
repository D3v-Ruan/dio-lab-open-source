...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/D3v-Ruan`;
    > Exemplo: `git checkout -b feat/community/D3v-Ruan`
...
teste Resolvendo, respondendo ou indicando **issues**
